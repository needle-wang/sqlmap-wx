...
class Model(object):
  ...
  # 测试(Q)
    ...
    self._tech_area_union_chr_ckbtn = cb()
    self._tech_area_union_chr_entry = tc()
  ...
  # 枚举(E)
    ...
    self._blind_area_first_entry = tc()
    self._blind_area_last_ckbtn = cb()
    self._blind_area_last_entry = tc()
    # 数据库名, 表名, 列名...
  ...
  # 其他(T)
    ...
    self._page1_misc_web_root_ckbtn = cb()
    self._page1_misc_web_root_entry = tc()
    self._page1_misc_tmp_dir_ckbtn = cb()
    self._page1_misc_tmp_dir_entry = tc()
    self._page1_misc_tmp_dir_chooser = btn()
    self._page1_misc_identify_waf_ckbtn = cb()
    self._page1_misc_skip_waf_ckbtn = cb()
    self._page1_misc_smart_ckbtn = cb()
